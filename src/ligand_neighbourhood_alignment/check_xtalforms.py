    ...
    for ref_xtalform_id, ref_xtalform in xtalforms.items():
        ...
        for mov_xtalform_id, mov_xtalform in xtalforms.items():
            ...
            ref_xtalform_protein_chains = [
                _chain for xtalform_assembly in ref_xtalform.assemblies.values() for _chain in xtalform_assembly.chains
            ]
            mov_xtalform_protein_chains = [
                _chain for xtalform_assembly in mov_xtalform.assemblies.values() for _chain in xtalform_assembly.chains
            ]
